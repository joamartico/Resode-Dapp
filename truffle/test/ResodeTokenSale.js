...
contract('ResodeTokenSale', function(accounts) {
    var tokenInstance;
    ...
    it('initializes the contract with the correct values', function() {
      return ResodeTokenSale.deployed().then(function(instance) {
    ...
    it('facilitates token buying', function() {
      return ResodeToken.deployed().then(function(instance) {
        // Grab token instance first
        tokenInstance = instance;
        return ResodeTokenSale.deployed();
